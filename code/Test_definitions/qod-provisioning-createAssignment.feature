Feature: CAMARA QoD Provisioning API, vwip - Operation createAssignment
    ...
    Background: Common createAssignment setup
        Given an environment at "apiRoot"
        And the resource "/qod-provisioning/vwip/qos-assignments"
    ...
    @qod_provisioning_createAssignment_01_generic_success_scenario
    ...
    @qod_provisioning_createAssignment_02_event_notification
    Scenario: Events for the outcome of assignment creation if sink is provided
        Given a valid testing device supported by the service, identified by the token or provided in the request body
        And the request property "$.qosProfile" is set to a valid QoS Profile as returned by QoS Profiles API
        ...
        And the event body property "$.data.assignmentId" has the same value as createAssignment response property "$.assignmentId"
    ...
    @qod_provisioning_createAssignment_03_3_legged_missing_device
    ...
    @qod_provisioning_createAssignment_C01.01_device_empty
    ...
    @qod_provisioning_createAssignment_C01.02_device_identifiers_not_schema_compliant
    ...
    @qod_provisioning_createAssignment_C01.03_device_not_found
    ...
    @qod_provisioning_createAssignment_C01.04_unnecessary_device
    ...
    @qod_provisioning_createAssignment_C01.05_missing_device
    ...
    @qod_provisioning_createAssignment_C01.06_unsupported_device
    ...
    @qod_provisioning_createAssignment_C01.07_device_not_supported
    ...
    @qod_provisioning_createAssignment_C01.08_device_identifiers_mismatch
    ...
    @qod_provisioning_createAssignment_400.1_schema_not_compliant
    ...
    @qod_provisioning_createAssignment_400.2_no_request_body
    ...
    @qod_provisioning_createAssignment_400.3_empty_request_body
    ...
    @qod_provisioning_createAssignment_400.7_invalid_sink_credential
    ...
    @qod_provisioning_createAssignment_400.8_sink_credential_invalid_token
    ...
    @qod_provisioning_createAssignment_400.9_non_existent_qos_profile
    ...
    @qod_provisioning_createAssignment_401.1_no_authorization_header
    ...
    @qod_provisioning_createAssignment_401.2_expired_access_token
    ...
    @qod_provisioning_createAssignment_401.3_invalid_access_token
    ...
    @qod_provisioning_createAssignment_409.1_assignment_conflict
    Scenario: Assignment conflict
        Given a valid testing device supported by the service, identified by the token or provided in the request body
        And a QoD assignment already exists for that device
        When the request "createAssignment" is sent
        And the response header "x-correlator" has same value as the request header "x-correlator"
        And the response header "Content-Type" is "application/json"
